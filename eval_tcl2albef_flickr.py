...
def retrieval_eval(model, ref_model, t_model, t_ref_model, t_test_transform, data_loader, tokenizer, t_tokenizer, device, config):
    ...
    # images: (batch_size(=4), 3, 384, 384)  texts_group: text output(e.g. len = 4)
    # images_ids: [52, 890, 186, 206] text_ids_groups: 4 imgs to texts (4 x 5)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_ckpt', default='./checkpoint/albef_retrieval_flickr.pth', type=str)       
